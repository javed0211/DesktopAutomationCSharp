...
namespace FullPageScreenCapture
{
    /// <summary>
    ...
    public class ScreenCapture
    {
        ...
        public void FullScreenCaptureJS(IWebDriver driver)
        {
            driver.Manage().Timeouts().PageLoad = TimeSpan.FromSeconds(20);
            IJavaScriptExecutor js = (IJavaScriptExecutor)driver;
            var html2canvasJs = File.ReadAllText($@"D:\DOT-Automation-SpecFlow\SpecFlow\SpecFlow\Data\html2canvas.js");
            ...
            wait.Until(
                wd =>
                {
                    string response = js.ExecuteScript
                        ("return (typeof canvasImgContentDecoded === 'undefined' || canvasImgContentDecoded === null)").ToString();
            ...
            wait.Until(wd => !string.IsNullOrEmpty((string)js.ExecuteScript("return window.canvasImgContentDecoded;")));
